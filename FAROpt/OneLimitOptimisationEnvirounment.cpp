...
void OneLimitOptimisationEnvirounment::fillOuts() {
...
void OneLimitOptimisationEnvirounment::fillY() {
...
void OneLimitOptimisationEnvirounment::fillA() {
	RP *rp = this->in->getRP();
...
NecIn *OneLimitOptimisationEnvirounment::getIn() {
	return in;
}

int OneLimitOptimisationEnvirounment::getSourceCount() {
...
Complex ****OneLimitOptimisationEnvirounment::getA() {
	return this->A;
}

int OneLimitOptimisationEnvirounment::getIDirect() {
	return this->iDirect;
}

int OneLimitOptimisationEnvirounment::getJDirect() {
	return this->jDirect;
}

ComplexMatrix *OneLimitOptimisationEnvirounment::getY() {
	return this->Y;
}